...
export class DockgeServer {
    ...
    socketHandlerList : SocketHandler[] = [ new MainSocketHandler(), new ManageAgentSocketHandler(), new ResourceUsageSocketHandler() ];
    ...
    getLocalWebSocketURL() { const p = this.isSSL() ? "wss" : "ws"; return `${p}://${this.config.hostname || "localhost"}:${this.config.port}`; }
}
