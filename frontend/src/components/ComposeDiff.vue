  ...
  <div class="shadow-box mb-3">
    <div class="d-flex justify-content-between align-items-center p-3 pb-2">
      <small class="text-muted">
        <font-awesome-icon icon="history" class="me-1" />Changes since last save
      </small>
      <button class="btn btn-sm btn-normal py-0" @click="$emit('close')">Dismiss</button>
    </div>
    <div v-if="!lines.length" class="px-3 pb-3 text-muted" style="font-size: 0.85em;">No changes.</div>
